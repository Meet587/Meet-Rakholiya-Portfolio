...
import { FaGithub, FaTwitter, FaInstagram, FaLinkedinIn, FaMedium } from "react-icons/fa";
...
const getIconColors = (title: string) => {
    switch (title) {
        ...
        case "Linkedin":
            return "text-blue-500 hover:text-blue-700";
        case "Leetcode":
            return "text-orange-300 hover:text-orange-400";
        case "Medium":
            return "text-gray-100 hover:text-gray-400";
        default:
            return "text-blue-500 hover:text-blue-700";
    }
};
